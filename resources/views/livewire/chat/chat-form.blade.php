<form wire:submit.prevent="sendMessage" class="row js-chatbox-form chatbox__form">
    ...
    <div class="col-2 reply-send p-1 d-flex align-items-center justify-content-center"> <button class="chatbox__form-submit u-btn p-0"><i class="fas fa-paper-plane m-0"></i></button></div>
</form>
